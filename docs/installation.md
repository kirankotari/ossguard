...
```bash
curl -fsSL https://github.com/kirankotari/ossguard-go/releases/download/v0.1.3/ossguard-macos-arm64 -o ossguard
chmod +x ossguard
...
```bash
curl -fsSL https://github.com/kirankotari/ossguard-go/releases/download/v0.1.3/ossguard-macos-amd64 -o ossguard
chmod +x ossguard
sudo mv ossguard /usr/local/bin/
```
...
```bash
curl -fsSL https://github.com/kirankotari/ossguard-go/releases/download/v0.1.3/ossguard-linux-amd64 -o ossguard
chmod +x ossguard
sudo mv ossguard /usr/local/bin/
```
...
```bash
curl -fsSL https://github.com/kirankotari/ossguard-go/releases/download/v0.1.3/ossguard-linux-arm64 -o ossguard
chmod +x ossguard
sudo mv ossguard /usr/local/bin/
```
...
docker run --rm -v "$(pwd):/project" ghcr.io/kirankotari/ossguard-go:0.1.3 scan /project

# Full audit
docker run --rm -v "$(pwd):/project" ghcr.io/kirankotari/ossguard-go:0.1.3 audit /project

# Bootstrap configs
docker run --rm -v "$(pwd):/project" ghcr.io/kirankotari/ossguard-go:0.1.3 init /project
```

**Tip**: Create a shell alias for convenience:

```bash
alias ossguard='docker run --rm -v "$(pwd):/project" ghcr.io/kirankotari/ossguard-go:0.1.3'
